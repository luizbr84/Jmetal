...
/**
 * Interface que publica os eventos do ciclo de vida de um experimento em um
 * arquivo
 * 
...
public class StreamMonoExperimentListener implements MonoExperimentListener {
	...
	/**
	 * Inicializa o analisador de experimentos que publica resultados em
	 * arquivos
	 * 
	 * @param writer
	 *            Nome do escritor onde os dados serão gravados
	 */
	...
	public void prepareInstance(int instanceNumber) throws IOException {
		...
		println("=============================================================");
		println("Cycle; time; obj; data 1..n; location; solution");
	}
