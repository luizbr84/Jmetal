package unirio.teaching.portfolio.general.model;
...
public class ProjetosCandidatos 
{
	...
	/**
	 * Altera o limite de orçamento como um percentual do custo total
	 */
	public void setPercentualLimiteOrcamento(double percLimiteOrcamento) 
	{
		double total = 0.0;
		
		for (Projeto projeto : projetos)
			total += projeto.getCusto();
		
		limiteOrcamento = -percLimiteOrcamento * total;
	}
}