...
public abstract class MultiExperiment<InstanceClass>
{
	 ...
	 */
	protected Vector<Solution> getUniqueSolutions(SolutionSet result) throws JMException
	{
	 ...
	 * @param cycleNumber		Número do ciclo de análise sendo executado
	 */
	public abstract SolutionSet runCycle(InstanceClass instance, int instanceNumber, int cycleNumber) throws Exception;
	...
	public void runCycles(InstanceClass instance, int instanceNumber, int cycles) throws Exception
	{
		...
		for (int i = 0; i < cycles; i++)
		{
			...
			SolutionSet result = runCycle(instance, instanceNumber, i);
